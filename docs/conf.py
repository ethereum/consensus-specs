...
htmlhelp_basename = 'eth2_specsdoc'
...
latex_documents = [
  ('index', 'eth2_specs.tex', '<PROJECT_NAME> Documentation',
   'Ethereum', 'manual'),
]
...
man_pages = [
    ('index', 'eth2_specs', '<PROJECT_NAME> Documentation',
     ['Ethereum'], 1)
]
...
texinfo_documents = [
  ('index', '<PROJECT_NAME>', '<PROJECT_NAME> Documentation',
   'Ethereum', '<PROJECT_NAME>', '<SHORT_DESCRIPTION>',
   'Miscellaneous'),
]
