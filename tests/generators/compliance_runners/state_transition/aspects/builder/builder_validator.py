...
def get_builder_solution(spec, beacon_state, builder_index: int) -> BuilderSolution:
...
def builder_validator(spec, beacon_state, solution: BuilderSolution, builder_index: int) -> bool:
    ...
    materialized_solution = get_builder_solution(spec, beacon_state, builder_index)
