...
PROVIDERS = (
    ...
    Provider("process_operations_dispatch", "operations_dispatch", "sanity", "blocks"),
    ...
    Provider("inactivity_updates", "inactivity_updates", "epoch_processing", "inactivity_updates"),
    Provider(
    ...
    Provider("registry_updates", "registry_updates", "epoch_processing", "registry_updates"),
    Provider(
        "rewards_and_penalties",
        "rewards_and_penalties",
        "epoch_processing",
    ...
    Provider("proposer_lookahead", "proposer_lookahead", "epoch_processing", "proposer_lookahead"),
    Provider(
        "participation_flag_updates",
        "participation_flag_updates",
        "epoch_processing",
