...
MAX_BLOCK_PUBKEY_CHANGES = 16
MAX_VALIDATOR_PUBKEY_CHANGES = 16
...
class Configuration(NamedTuple):
    ...
    REVOKE_FORK_VERSION: Version
    REVOKE_FORK_EPOCH: Epoch
...
config = Configuration(
    ...
    REVOKE_FORK_VERSION=Version('0x04000000'),
    REVOKE_FORK_EPOCH=Epoch(18446744073709551615),
)
...
class Validator(Container):
    ...
    prev_pubkeys: List[BLSPubkey, MAX_VALIDATOR_PUBKEY_CHANGES]
...
# REVOKETODO: What if pubkey changing?
...
def process_operations(state: BeaconState, body: BeaconBlockBody) -> None:
    ...
    #REVOKETODO: What happens if 2 changes for same validator in same block?
