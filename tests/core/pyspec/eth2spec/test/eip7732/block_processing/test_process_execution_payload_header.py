...
def prepare_signed_execution_payload_header(spec, state, builder_index=None, value=None, 
                                          slot=None, parent_block_hash=None, 
                                          parent_block_root=None, fee_recipient=None,
                                          gas_limit=None, block_hash=None,
...
def test_process_execution_payload_header_valid_builder(spec, state):
    ...
    pre_pending_payments_len = len([p for p in state.builder_pending_payments if p.withdrawal.amount > 0])
