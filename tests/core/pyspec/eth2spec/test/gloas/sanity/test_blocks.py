...
from eth2spec.test.helpers.payload_attestation import (
...
def test_payload_attestation_included_in_block(spec, state):
    ...
    payload_attestations = get_random_payload_attestations(spec, state, rng=__import__('random').Random(1234))
