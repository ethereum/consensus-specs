...
class WithdrawalReceiptIndex(uint64):
    pass
...
WITHDRAWAL_RECEIPT_LIMIT = uint64(2**40)
...
class BeaconState(Container):
    ...
    # Withdrawals
    withdrawal_receipts: List[WithdrawalReceipt, WITHDRAWAL_RECEIPT_LIMIT]  # [New in Withdrawals]
...
def process_epoch(state: BeaconState) -> None:
    ...
    process_withdrawals(state)  # [New in Withdrawals]
