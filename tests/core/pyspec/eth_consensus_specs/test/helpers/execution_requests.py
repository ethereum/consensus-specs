...
def get_max_withdrawal_requests(spec):
    return spec.MAX_WITHDRAWAL_REQUESTS_PER_PAYLOAD


def get_max_builder_exit_requests(spec):
    return spec.MAX_BUILDER_EXIT_REQUESTS_PER_PAYLOAD
