...
DEFAULT_OUTPUT_DIR: str = "tests/core/pyspec/eth_consensus_specs/test"
...
from eth_consensus_specs.test.helpers.constants import {phase}
...
class RandomizedTestGenerator:
    ...
    FORK_CONFIGS: ClassVar[dict[str, ForkConfig]] = {
        ...
        HEZE: ForkConfig(
            ...
            block_randomizer=random_block_heze,
        ),
    }
