...
FORK_EPOCH = 2
FORK_CONFIG = {"EIP8198_FORK_EPOCH": FORK_EPOCH}
...
def test_on_tick_ms_fork_boundary_and_deadlines(spec, state):
    ...
    second_post_slot_start_ms = fork_time_ms + spec.config.SLOT_DURATION_MS_EIP8198
    ...
    offsets_ms = (
        ...
        spec.get_proposer_reorg_cutoff_ms() + 1,
        spec.get_inclusion_list_due_ms(),
        spec.get_inclusion_list_due_ms() + 1,
    )
