...
def test_gloas_fork_random_0(spec, phases, state):
...
@with_state
@with_meta_tags(GLOAS_FORK_TEST_META_TAGS)
def test_gloas_fork_random_1(spec, phases, state):
...
@with_state
@with_meta_tags(GLOAS_FORK_TEST_META_TAGS)
def test_gloas_fork_random_2(spec, phases, state):
...
@with_state
@with_meta_tags(GLOAS_FORK_TEST_META_TAGS)
def test_gloas_fork_random_3(spec, phases, state):
...
@with_meta_tags(GLOAS_FORK_TEST_META_TAGS)
def test_gloas_fork_random_low_balances(spec, phases, state):
...
@with_meta_tags(GLOAS_FORK_TEST_META_TAGS)
def test_gloas_fork_random_misc_balances(spec, phases, state):
...
@with_meta_tags(GLOAS_FORK_TEST_META_TAGS)
def test_gloas_fork_random_large_validator_set(spec, phases, state):
