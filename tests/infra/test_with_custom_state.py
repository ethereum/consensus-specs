...
def clear_custom_state_cache():
    _custom_state_cache_dict.clear()
    yield
    _custom_state_cache_dict.clear()


def test_with_custom_state_injects_state_view():
...
def test_with_custom_state_caches_for_identical_key():
    spec = spec_targets[MINIMAL][PHASE0]
...
def test_with_custom_state_changes_cache_key_when_balances_fn_differs():
    spec = spec_targets[MINIMAL][PHASE0]
...
def test_with_custom_state_changes_cache_key_when_threshold_fn_differs():
    spec = spec_targets[MINIMAL][PHASE0]
