...
class Dumper:
    ...
    def dump_manifest(self, dir: Path, manifest_data: dict) -> None:
        ...
        self._dump_yaml(dir, "manifest", manifest_data, self.cfg_yaml)

    def _dump_yaml(self, dir: str, name: str, data: any, yaml_encoder: YAML) -> None:
