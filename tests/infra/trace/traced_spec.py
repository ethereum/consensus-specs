...
3. State context (injecting load_state/assert_state when it's changed in the test)
"""
...
class RecordingSpec(wrapt.ObjectProxy):
    ...
    # --- Interception Logic ---
    # FIXME: this is a little weird and not quite wrapt-aligned
    # this getattr thing is basically overriding everything, suggestions welcome
