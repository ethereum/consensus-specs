...
def test_yield_generator_post_processing_with_none_values():
...
def test_yield_generator_post_processing_with_bytes():
...
def test_yield_generator_post_processing_with_preformatted():
...
def test_yield_generator_post_processing_with_data():
...
def test_yield_generator_post_processing_with_bytes_list():
...
def test_vector_test_with_non_generator_function():
...
def test_vector_test_with_non_generator_function_with_generator_mode():
...
def test_vector_test_with_generator_is_pytest_true():
...
def test_vector_test_with_generator_is_pytest_false_generator_mode_true():
...
def test_vector_test_with_generator_is_pytest_false_generator_mode_false():
...
def test_vector_test_with_generator_is_pytest_false_no_generator_mode():
...
def test_vector_test_with_generator_mode_parameter_is_popped():
...
def test_vector_test_with_generator_post_processing_integration():
    """Test that _yield_generator_post_processing is properly integrated."""

    def generator_function():
        # Mix of different data types
        yield ("none_key", None)  # Should be skipped
        yield ("string_key", "string_value")  # Should become ("string_key", "data", "string_value")
        yield ("bytes_key", b"bytes_value")  # Should become ("bytes_key", "ssz", b"bytes_value")
...
def test_vector_test_with_generator_with_args_and_kwargs():
