...
from typing import Any, BinaryIO, Callable, Iterable, List as PyList, Optional, Tuple, Type, TypeVar, _ProtocolMeta
...
class BasicView(FixedByteLengthViewHelper, BasicTypeDef):
    ...
    def default_node(cls: Any) -> Node: ...
    @classmethod
    def view_from_backing(cls: Type[BV], node: Node, hook: Optional[ViewHook[BV]]=...) -> V: ...
    @classmethod
    def basic_view_from_backing(cls: Type[BV], node: Node, i: int) -> BV: ...
    @classmethod
    def pack_views(cls: Type[BV], views: PyList[BV]) -> PyList[Node]: ...
