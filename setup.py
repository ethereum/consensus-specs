...
# EIP7002SpecBuilder
#
class EIP7002SpecBuilder(DenebSpecBuilder):
    fork: str = EIP7002
...
all_builders = (
    ...
    EIP6110SpecBuilder, EIP7002SpecBuilder,
)
...
class PySpecCommand(Command):
    ...
    def finalize_options(self):
        ...
        if len(self.md_doc_paths) == 0:
            ...
            if self.spec_fork in (PHASE0, ALTAIR, BELLATRIX, CAPELLA, DENEB, EIP6110, EIP7002):
                self.md_doc_paths = """
            ...
            if self.spec_fork in (ALTAIR, BELLATRIX, CAPELLA, DENEB, EIP6110, EIP7002):
                ...
                """
            if self.spec_fork in (BELLATRIX, CAPELLA, DENEB, EIP6110, EIP7002):
                self.md_doc_paths += """
                    ...
                    sync/optimistic.md
                """
            if self.spec_fork in (CAPELLA, DENEB, EIP6110, EIP7002):
                self.md_doc_paths += """
                ...
                """
            if self.spec_fork in (DENEB, EIP6110, EIP7002):
                self.md_doc_paths += """
