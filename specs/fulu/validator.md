...
`MIN_EPOCHS_FOR_BLOB_SIDECARS_REQUESTS` epochs, the node SHOULD update their `custody_group_count`
to reflect their new custody requirement and MAY prune data which is no longer required to be
