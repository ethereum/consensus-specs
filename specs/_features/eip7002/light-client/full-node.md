# EIP-7002 Light Client -- Full Node
...
This upgrade adds information about the execution payload to light client data as part of the EIP-7002 upgrade.
...
def block_to_light_client_header(block: SignedBeaconBlock) -> LightClientHeader:
    ...
    if epoch >= CAPELLA_FORK_EPOCH:
        ...
        if epoch >= EIP7002_FORK_EPOCH:
            execution_header.exits_root = hash_tree_root(payload.exits)
