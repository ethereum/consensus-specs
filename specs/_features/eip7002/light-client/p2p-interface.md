# EIP-7002 Light Client -- Networking
...
The [Deneb light client networking specification](../../deneb/light-client/p2p-interface.md) is extended to exchange [EIP-7002 light client data](./sync-protocol.md).
...
| `EIP7002_FORK_VERSION` and later                       | `eip7002.LightClientFinalityUpdate` |
...
| `EIP7002_FORK_VERSION` and later                       | `eip7002.LightClientOptimisticUpdate` |
...
| `EIP7002_FORK_VERSION` and later                       | `eip7002.LightClientBootstrap`     |
...
| `EIP7002_FORK_VERSION` and later                       | `eip7002.LightClientUpdate`      |
