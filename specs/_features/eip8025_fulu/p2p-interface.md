# EIP-8025 (Fulu) -- Networking

This document contains the networking specification for EIP-8025 on Fulu.
...
- _[IGNORE]_ The proof is the first valid proof received for the tuple
  `(proof.message.public_inputs.new_payload_request_root, proof.message.proof_type, prover_pubkey)`.
