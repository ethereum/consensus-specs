...
* **Active validator set** - those validators who are currently participating, and which the Casper mechan
m looks to produce and attest to blocks, crosslinks and other consensus objects.
