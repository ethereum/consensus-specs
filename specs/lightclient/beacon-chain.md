...
* Incentive accounting reforms, reducing spec complexity
  and reducing the cost of processing chains that have very little or zero participation for a long span of epochs
...
Additionally, it is split into `get_base_reward_per_eth` to allow penalties to be computed to the denominator.
