...
`step` is deprecated for all `beacon_blocks_by_range` requests and MUST be set to 1. 
If a larger step is given during the deprecation transition period, clients MAY respond with either a single block OR honor the step. 
