...
The
[Electra light client networking specification](../../electra/light-client/p2p-interface.md)
is extended to exchange [Gloas light client data](./sync-protocol.md).
